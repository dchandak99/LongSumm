...
Varun Madhavan  & Devansh Chandak & Aditya Girish Pawate \\
{\normalfont \textsc{IIT Kharagpur}} & {\normalfont \textsc{IIT Bombay}} & {\normalfont \textsc{IIT Kharagpur}} \\
{\normalfont \texttt{email@domain}} & {\normalfont \texttt{email@domain}} & \texttt{\normalfont \texttt{email@domain}}
\end{tabular}
\addtolength{\tabcolsep}{-16pt} 
}

\title{Long Summaries for Scientific Documents}
